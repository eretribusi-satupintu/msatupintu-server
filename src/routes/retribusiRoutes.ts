...
import {
  getSewaWajibRetribusi,
  getItemWajibRetribusiKontrak,
  getRetribusiDetail,
} from "../controllers/retribusiController";
...
router.get(
  "/get/wajib-retribusi/:wr_id/item-retribusi/:retribusi_id",
  async (req: Request, res: Response) => {
    try {
      const data = await getItemWajibRetribusiKontrak(
